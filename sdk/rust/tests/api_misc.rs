//! Endpoint tests for the remaining API namespaces: reputation, explorer,
//! admin, moderation, and stats. Each test points the client at a catch-all
//! mock, invokes one public method, and asserts the request method + path.
