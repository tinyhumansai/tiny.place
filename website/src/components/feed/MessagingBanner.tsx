 ...
 * GitBook hero artwork (served from `/heroes`). Purely visual — hidden from
 * assistive tech — so it carries no text or link.
 */
export function MessagingBanner(): FunctionComponent {
	return (
		<div
			...
			style={{ backgroundImage: "url('/heroes/hero-messaging.png')" }}
		>
